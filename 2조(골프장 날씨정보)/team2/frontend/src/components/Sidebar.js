...
const Sidebar = ({ detailData, setDetailData }) => {
  ...
  const golfInfo = detailData;
  const weather = [
    {
      T1H: detailData.TA, // 기온
      humidity: detailData.HM, // 습도
      WSD: detailData.WS, // 풍속
      RN1: detailData.RN, // 강수량
    },
  ];
  ...
  return (
    <>
      {/* <div className="detail-container">
        <button onClick={() => setSidebarWidth(0)} className="detail-close-btn">
          닫기 ✕
        </button>
